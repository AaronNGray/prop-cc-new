...
//  The original source file is "metasyntax.pcc".
///////////////////////////////////////////////////////////////////////////////

#line 1 "metasyntax.pcc"
///////////////////////////////////////////////////////////////////////////////
//
...
public:
  ...
  std::size_t    memory_used;   // total memory used for the parsers and lexers
...
struct GrammarRecord
{
  ...
  std::size_t  memory_used;    // memory used for this grammar
...
void MetaSyntaxCompiler::flush_grammar( std::size_t memory_needed)
{
